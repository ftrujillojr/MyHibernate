...
/**
 * All of the methods return Base64 encoded strings in the form
 * randomBase64Salt:hashBase64.
 *
 * The salt is randomized for each call to hash methods. The PEPPER is changed
 * in STATIC vars to further flip bits in the random salt prior to generating
 * hash.
 *
...
public class SHAUtils {
    ...
    /**
     * DO NOT USE THIS METHOD to store passwords in database. (see
     * generatePBKDF2Hash)
     *
     * @param myString
     * @return String saltBase64:hashBase64 (133) characters
...
//        String base64EncodedString = encoder.encodeToString(byteArray);
    ...
    public static byte[] base64StringToByteArray(String myStr) {
        ...
        byte[] byteArray = Base64.decodeBase64(myStr);
